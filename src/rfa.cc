...
static const char* kAppName = "Anaguma";

static const RFA_String kContextName ("RFA");
static const RFA_String kConnectionType ("RSSL_PROV");
...
anaguma::rfa_t::rfa_t (const config_t& config) :
	config_ (config)
{
}
